...
namespace RPGCharacterAnims
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""Pull Hide Weapon"",
                    ""type"": ""Button"",
                    ""id"": ""827ed59a-899a-46b8-bd5c-dba53b2cf61c"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""d6d8f070-71ed-41f6-8155-48b950651562"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c202840d-f5d0-4c0c-8f55-c27cf4466adc"",
                ...
                {
                    ""name"": """",
                    ""id"": ""71b462a3-081a-4faf-b66f-c0ce9a554985"",
                    ""path"": ""<Keyboard>/v"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse and Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""2312c058-c4b9-473d-b627-3804a6174054"",
                    ""path"": ""<Keyboard>/x"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""Pull Hide Weapon"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_RPGCharacter_PullHideWeapon = m_RPGCharacter.FindAction("Pull Hide Weapon", throwIfNotFound: true);
        }
        ...
        private readonly InputAction m_RPGCharacter_PullHideWeapon;
        public struct RPGCharacterActions
        {
            ...
            public InputAction @PullHideWeapon => m_Wrapper.m_RPGCharacter_PullHideWeapon;
            ...
            public void SetCallbacks(IRPGCharacterActions instance)
            {
                if (m_Wrapper.m_RPGCharacterActionsCallbackInterface != null)
                {
                    ...
                    @PullHideWeapon.started -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnPullHideWeapon;
                    @PullHideWeapon.performed -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnPullHideWeapon;
                    @PullHideWeapon.canceled -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnPullHideWeapon;
                }
                ...
                if (instance != null)
                {
                    ...
                    @PullHideWeapon.started += instance.OnPullHideWeapon;
                    @PullHideWeapon.performed += instance.OnPullHideWeapon;
                    @PullHideWeapon.canceled += instance.OnPullHideWeapon;
                }
            }
        }
        ...
        public interface IRPGCharacterActions
        {
            ...
            void OnPullHideWeapon(InputAction.CallbackContext context);
        }
    }
}
